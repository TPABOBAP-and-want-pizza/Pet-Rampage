...
{
    const string privateCode = "ZOZEwjMZfESUTPt57EgxvQzB2BrO51Z0OL5vepLdnVdQ";  //Key to Upload New Info
    const string publicCode = "656d20708f40bb1054d58291";   //Key to download
